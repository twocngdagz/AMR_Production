...
<!--	<label for="catalogueID">Catalogue ID:</label>
	...
	<div class="uploadfile">
		<?php if ($imagePath):?>
			<a href="<?php echo site_url($imageThumbPath); ?>" title="<?php echo set_value('productName', $data['productName']); ?>" class="lightbox">
              <img src="<?php echo site_url($imagePath); ?>" alt="Product image" class="pic" />
            </a><br />
		<?php endif; ?>
...
<div id="prod-images" class="tab">	
    ...
    <?php if(!empty($image_1_src)): ?>
    <br class="clear" />
    <img src="<?php echo $image_1_src; ?>" />
    <?php endif; ?>
	<br class="clear" />
    ...
    <?php if(!empty($image_2_src)): ?>
    <br class="clear" />
    <img src="<?php echo $image_2_src; ?>" />
    <?php endif; ?>
	<br class="clear" />
    ...
    <?php if(!empty($image_3_src)): ?>
    <br class="clear" />
    <img src="<?php echo $image_3_src; ?>" />
    <?php endif; ?>
	<br class="clear" />
	...
	<?php if(!empty($image_4_src)): ?>
    <br class="clear" />
    <img src="<?php echo $image_4_src; ?>" />
    <?php endif; ?>
	<br class="clear" />
	...
	<?php if(!empty($image_5_src)): ?>
    <br class="clear" />
    <img src="<?php echo $image_5_src; ?>" />
    <?php endif; ?>
	<br class="clear" />
