...
<div id="emailsconfig" class="tab">
	...
	<?php if (@in_array('shop', $this->permission->sitePermissions)): ?>
		...
		<label for="emailGiftcard">Gift Card Email:</label>
		<?php echo @form_textarea('emailGiftcard', set_value('emailGiftcard', $data['emailGiftcard']), 'id="emailGiftcard" class="formelement small"'); ?>
		<br class="clear" />
		<span class="tip nolabel">Customise the email send out for gift cards.</span>
		<br class="clear" /><br />
